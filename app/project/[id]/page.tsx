    ...
    return (
        <Modal>
            ...
            <section className="flexCenter flex-col mt-20">
                <p className="max-w-5xl text-xl font-normal mb-2 flex ">
                     Genre :
                    <span className='ml-4'>
                ...
                <div className="flex flex-wrap mt-5 gap-5">
                    <div  className="flexCenter gap-2 tex-sm font-medium text-primary-purple">
                        🖥 <span>episode : {projectDetails?.episode} </span> 
                    </div>
                    <Image src="/dot.svg" width={4} height={4} alt="dot" />
